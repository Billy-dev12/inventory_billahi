...
<body>
  ...
  <div class="container mt-4">
    ...
    <a href="view_tambahan.php" class="btn btn-primary mb-3">Tambah Data Barang</a>
    ...
    <table class="table table-bordered table-striped">
      ...
      ?>
        <tr>
          ...
          <td>
            <a href='view_edit.php?id=<?php echo $result['id_barang'] ?>' class="btn btn-warning btn-sm">Edit</a>
            <a href='hapus.php?id=<?php echo $result['id_barang'] ?>' onclick="return confirm('Apakah kamu yakin?')" class="btn btn-danger btn-sm">Hapus</a>
          </td>
        </tr>
      <?php 
          $no++;
